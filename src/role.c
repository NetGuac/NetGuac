...
const struct Role roles[] = {
	...
	{ { "Caveman", "Cavewoman" },
      ...
      SPE_DIG,
      -4 },
	{ { "Fisherman", "Fisherwoman" }, /* most of this comes from The Rime of the Ancient Mariner */
      { { "1", 0 },
        { "2", 0 },
        { "3", 0 },
        { "4", 0 },
        ...
        { "8", 0 },
        { "9", 0 } },
      "Sydyk", "Kothar-wa-Khasis", "Anat", 
      "Fis",
      "the Mariner's Cave",
      "the Albatross's Nest",
      PM_FISHERMAN,
      PM_FISHERWOMAN,
      PM_KITTEN,
      PM_ANCIENT_MARINER,
      ...
      S_GIANT,
      ART_ROD_OF_RODNESS,
      MH_HUMAN | MH_GNOME | ROLE_MALE | ROLE_FEMALE 
          | ROLE_NEUTRAL,
      /* Str Int Wis Dex Con Cha */
      { 10, 7, 7, 7, 8, 6 },
      { 30, 6, 7, 20, 30, 7 },
